...
<div class="main">
  ...
  <div class="content">
    ...
    try{
			...
			String sql="SELECT * FROM creditcard where  card_no='"+cardno+"' ";
			...
			if(rs.next()==true)
			{
				...
				String sql1="update creditcard set amount='"+amt+"' where card_no='"+cardno+"' ";
...
<p><br/>
  ...
  <%
		...
		out.print("Credit Card Not Found!!..");
