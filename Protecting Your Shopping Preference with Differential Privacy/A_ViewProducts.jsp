...
<div class="main">
  ...
  <tr>
   ...
   <td width="178"><div align="center" style="color:#660000"><strong>Uploader Site</strong></div></td>
...
<%
  ...
  <tr>
	  ...
	  <td><div align="center" style="color:#FF3333"><strong><%=s8%></strong></div></td>
    ...
    <td><div align="center" style="color:#000000"><%=s3%></div></td>
     <td><div align="center" style="color:#000000"><%=decryptedDes%></div></td>
			   ...
			   <td><div align="center" style="color:#000000"><%=r%></div></td>
		  	   <td><div align="center"><a href="A_reviews.jsp?p_Name=<%= s2%>&amp;p_Category=<%=s9%>&amp;site=<%=s8%>">Reviews</a></div></td>
  </tr>
