      ...
      <div class="mainbar">
        <div class="article">
          ...
          <div>
                    ...
                    <form action="A_AddMoneyAuthentication.jsp" method="post" >
                      <span class="style48">
                      <label for="name"><span class="style49 style4">Credit Card Number(required)</span></label>
                      </span>
                      <p class="style4 style50"><strong>
                      <input type="text"  name="cardno" />
                      </strong></p>
                      <span class="style4 style50"><strong>
		...
		<p align="left" class="style22"><a href="AdminMain.jsp" class="style11">Back</a></p>
                    </form>
            </div>
          </div>
          <div class="clr"></div>
