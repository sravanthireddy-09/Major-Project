...
<head>
<title>Product Search Ratio Chart</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Product Search Ratio</span> on Pie Chart... </h2>
          <p class="infopost" align="right"><%=new java.util.Date()%> </p>
          <div class="clr"></div>
          
          <div class="rf">
           <iframe width="650" height="500" src="SearchRatioChart.jsp"></iframe>
			      <div align="left" class="style11 style2">( Keywords Used for Searching Products )</div>
				    <p>&nbsp;</p>
