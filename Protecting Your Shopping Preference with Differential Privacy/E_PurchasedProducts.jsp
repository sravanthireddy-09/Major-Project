...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style1"><a href="#"><span class="style1"><span class="style2"> <span class="style2"><span class="style2" style="color:#FFFF00"><%=(String)application.getAttribute("esite")%> </span>User's Purchased Products..</span></span></span></a></h2>
...
<table width="730" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
                    <tr>
                      <td  width="60"  valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style13"><strong>Si No. </strong></div></td>
					  <td  width="133" valign="middle" style="color: #2c83b0;"><div align="center" class="style13"><strong>Purchased User</strong></div></td>
                      <td  width="133" valign="middle" style="color: #2c83b0;"><div align="center" class="style13"><strong>Product Name</strong></div></td>
                      <td  width="133" valign="middle" style="color: #2c83b0;"><div align="center" class="style13"><strong>Category</strong></div></td>
                      <td  width="106" valign="middle" style="color: #2c83b0;"><div align="center" class="style13"><strong>Price</strong></div></td>
					  
                      <td  width="108" valign="middle" style="color: #2c83b0;"><div align="center" class="style13"><strong>Date</strong></div></td>
                    </tr>
