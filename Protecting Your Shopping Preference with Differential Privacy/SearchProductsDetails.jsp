...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="title"><a href="#"><span class="style2">Searched Product</span><span class="style9"> <%=request.getParameter("p_Name")%>  </span><span class="style2">Details..</span></a></h2>
		  ...
		  <%
					...
					String str1="select * from products where p_name='"+p_Name+"' and categoryname='"+p_Category+"' and site='"+site+"' "; 
			...
			%>
			      <table width="598" border="1" align="left" cellpadding="0" cellspacing="0" >
					...
					<tr >
                      <td height="46" ><div align="center" class="style6">Ecommerce Web</div></td>
