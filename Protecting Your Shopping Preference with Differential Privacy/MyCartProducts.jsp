          ...
          <div class="rf">
             <table width="606" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
                      <tr>
						...
						<td  width="113" valign="middle" style="color: #2c83b0;"><div align="center" class="style52 style55 style5 style84 style37"><strong>Site</strong></div></td>
                      ...
                      <%
						...
						try 
						{
							...
							String user=(String)application.getAttribute("uname");
						   	String strQuery9 = "select p_name,category,price,site from cart where user='"+user+"'";
					   		...
					   		while ( rs.next() )
					   		{
									...
									%>
                      <tr>
                        <td height="172" align="center"  valign="middle"><div align="center" class="style7"><strong>
                            <%out.println(j);%>
                        </strong></div></td>
                        ...
                        <td height="172" align="center"  valign="middle">
							<form id="form1" name="form1" method="post" action="Purchase.jsp">
							<input type="hidden" value="<%=s1%>" name="p_Name"/>
							<input type="hidden" value="<%=s2%>" name="p_Category"/>	
							<input type="hidden" value="<%=s3%>" name="site"/>						
