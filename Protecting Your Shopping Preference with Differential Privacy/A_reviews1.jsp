...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="title"><a href="#"><span class="style2">Video Product</span><span class="style9"> <%=request.getParameter("p_Name")%>  </span><span class="style2">Review Details..</span></a></h2>
...
%>
          ...
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p><a href="A_ViewVideoProducts.jsp" class="style11"><strong>Back</strong></a></p>
          </div>
          <div class="clr"></div>
        </div>
        </div>
