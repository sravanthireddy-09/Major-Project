...
<head>
<title>Fraud Trace Details..</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Differential Privacy Detection</span> Details.. </h2>
          ...
          <table width="592" border="1" align="left"  cellpadding="0" cellspacing="0"  ">
                    ...
                    <%
						...
						try 
						{
						   	String query="select * from fraud where site='"+site+"' "; 
		          ...
		          <p>&nbsp;</p>
		          <p>&nbsp;</p>
		          <p align="center"><a href="EcommerceMain.jsp" class="style16">Back</a></p>
          </div>
          <div class="clr"></div>
        </div>
      </div>
