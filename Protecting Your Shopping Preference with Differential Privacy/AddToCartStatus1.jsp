...
<head>
<title>Video Product Purchase</title>
...
<div class="main">
 ...
 <p>
			...
			if(rs.next())
			{
								...
								String sql1="SELECT * FROM videoproducts where p_name='"+p_Name+"' and category='"+p_Category+"' and site='"+vsite+"' ";
								...
								if(rs1.next()==true)
								{
										...
										SimpleDateFormat sdfDate = new SimpleDateFormat("dd/MM/yyyy");
											   ...
											   String det1="Transaction declined due to fraud activity";
														...
														ps22.setString(3,vpr);
														ps22.setString(4,vsite);
										...
										else
										{
											   ...
											   String date = strDate + "   " + strTime;
											    ...
											    String sql2="SELECT * FROM cart where (p_name='"+p_Name+"' and category='"+p_Category+"') and (user='"+user+"' and site='"+vsite+"') ";
              ...
              <%
					...
					{	 
											   ...
											   String det="Invalid Credit Card Credentials";
														...
														ps21.setString(4,vpr);
														ps21.setString(5,vsite);
