...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="title"><a href="#"><span class="style11">Product</span><span class="style9"> <%=request.getParameter("p_Name")%>  </span><span class="style11">Details..</span></a></h2>
...
%>
				   ...
				   <div align="center">
				     ...
				     <p>&nbsp;</p>
				     <p>&nbsp;</p>
				     <p><a href="MyCartProducts.jsp" class="style12">Back</a></p>
				   </div>
	      </div>
          <div class="clr"></div>
        </div>
