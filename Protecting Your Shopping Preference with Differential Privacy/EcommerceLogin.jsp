...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Welcome To </span>MerchantUser Login </h2>
          ...
          <form id="form1" name="form1" method="post" action="EcommerceAuthentication.jsp">
				    ...
				    <table width="464" border="4" align="center" cellpadding="2" cellspacing="2">
                      <tr>
                        <td width="197" height="46" align="center"><span class="style34 style2"><strong>
                          <label for="name">Select MerchantSite </label>
                        </strong></span> </td>
                      ...
                      <tr>
                        <td height="40" align="center"><span class="style34 style2"><strong>Password (required)</strong></span></td>
                      ...
                      <tr>
                        ...
                        <td><span class="style16">
                          ...
                          <strong> New User?</strong></span><a href="EcommerceRegister.jsp" class="style30"> Register </a></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
