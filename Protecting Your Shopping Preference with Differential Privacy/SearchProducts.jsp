...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Search Products by </span> content keyword.. </h2>
        ...
        <div class="article">
          ...
          <div class="rf">
            <p>
              <%
  String input="",l_Input="",p_Name="",p_Desc="",p_Desc1="",p_Price="",p_Category="",vp_Name="",vp_Desc="",vp_Desc1="",vp_Price="",vp_Category="",site="",vsite=""; 
			int i=0,j=0,k=0,a1=0,a11=0,rank=0,vrank=0;
...
{	
			...
			SimpleDateFormat sdfDate = new SimpleDateFormat("dd/MM/yyyy");
							...
							String dt = strDate + "   " + strTime;
								...
								while(rs.next())
								{
									...
									p_Desc1 = decryptedDes.toLowerCase(); 
			...
			String str4 = "insert into productsearch (user,p_name,category,keyword,dt) values('"+uname+"','"+p_Name+"','"+p_Category+"','"+input+"','"+dt+"')";
              ...
              <tr>
                ...
                <td width="97" height="55"><div align="center">
                    <p class="style50"><a href="SearchProductsDetails.jsp?p_Name=<%=p_Name%>&amp;keyword=<%=l_Input%>&amp;p_Category=<%=p_Category%>&amp;rank=<%=rank%>&amp;site=<%=site%>" class="style56 style30"><strong>View Details</strong></a></p>
                </div></td>
              </tr>
              <%	}
			...
			<p>
			  ...
			  String str2= "select * from videoproducts";
								Statement st2=connection.createStatement();
								ResultSet rs2 = st2.executeQuery(str2);
								
								while(rs2.next())
								{
								    vp_Name = rs2.getString(3);
									vp_Price = rs2.getString(4);
									vp_Category = rs2.getString(2); 
								    vrank   = rs2.getInt(10);
									vp_Desc = rs2.getString(7);
									vsite  = rs2.getString(11);
									
									String vdecryptedDes= new String(Base64.decode(vp_Desc.getBytes()));
								
									vp_Desc1 = vdecryptedDes.toLowerCase(); 
									 
									if (vp_Desc1.indexOf(l_Input)>=0)
									{
									
									
									String str3 = "insert into productsearch (user,p_name,category,keyword,dt) values('"+uname+"','"+vp_Name+"','"+vp_Category+"','"+input+"','"+dt+"')";
			...
			<table width="506" border="1" align="center">
              <tr>
                <td colspan="4" align="center" class="style2">Results Found in Vidoe Products</td>
              </tr>
              <tr>
                <td width="130" align="center" valign="middle"><span class="style3">File Name </span></td>
                <td width="192" align="center" valign="middle"><span class="style3">Description</span></td>
                <td width="59" align="center" valign="middle"><span class="style3">Rank</span></td>
              </tr>
              <%}a11=1;%>
              <tr>
                <td height="55" align="center" valign="middle"><div align="center" class="style5"><strong><%=vp_Name%></strong></div></td>
                <td align="center" valign="middle"><span class="style14">
                  <textarea name="textarea2" rows="5"><%=vp_Desc1%></textarea>
                </span></td>
                <td align="center" valign="middle"><div align="center" class="style5"><strong><%=vrank%></strong></div></td>
                <td width="97" height="55"><div align="center">
                    <p class="style50"><a href="SearchVideoProductsDetails.jsp?p_Name=<%=vp_Name%>&amp;keyword=<%=l_Input%>&amp;p_Category=<%=vp_Category%>&amp;rank=<%=vrank%>&amp;vsite=<%=vsite%>" class="style50"><strong> View Details</strong></a></p>
                </div></td>
              </tr>
              <%	}
